import java.util.ArrayList; //to contain the array collection for SE
public class TechnicalLead extends TechnicalEmployee //TL inherits TE class
{
    public ArrayList<SoftwareEngineer> team; //array to hold the SE list
    ...
    public boolean approveCheckIn(SoftwareEngineer e)
    {
        ...
        {//Should see if the employee passed in does report to this manager and if their code access is currently
            // set to "true".
